...
const filePath = path.join(__dirname, 'frontend/src/Admin/CreateProduct.js');
let code = fs.readFileSync(filePath, 'utf8');

const returnRegex = /return \(\s*<Container\s*fluid\s*className="bg-light admin-page"[\s\S]*?\);\s*};\s*export default/m;
...
const newReturn = `return (
    <Container fluid className="admin-page" style={{ minHeight: "100vh", backgroundColor: "#f8fafc", padding: 0 }}>
      ...
      <Row className="g-0">
        ...
        <Col className="p-4" style={{ paddingBottom: "100px !important" }}>
          <style>{\`
          ...
          <div className="admin-create-product-header">
            <Button
              ...
              className="me-4 shadow-sm border-0 bg-light"
            >
...
console.log('Successfully updated CreateProduct.js');
